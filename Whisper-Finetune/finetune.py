...
if __name__ == '__main__':
    ...
    add_arg("base_model",    type=str, default="../whisper-small-finetune",      help="Whisper的基础模型")
    #add_arg("base_model", type=str, default="openai/whisper-small", help="Whisper的基础模型")
    ...
    add_arg("num_workers",   type=int, default=3,       help="读取数据的线程数量")
