...
add_arg("audio_path",  type=str,  default="../dataset/2/7.wav",        help="预测的音频路径")
add_arg("model_path",  type=str,  default="models/small50-ct2", help="转换后的模型路径，转换方式看文档")
...
if args.use_gpu:
    ...
    model = WhisperModel(args.model_path, device="cpu", compute_type="int8", num_workers=args.num_workers,
                         local_files_only=args.local_files_only)
# 预热
_, _ = model.transcribe("temp/tempAudio.wav", beam_size=5)
