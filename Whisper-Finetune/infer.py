...
# 设置参数
output_file = '../dataset/2/27.wav'  # 音频文件保存路径

parser = argparse.ArgumentParser(description=__doc__)
add_arg = functools.partial(add_arguments, argparser=parser)
add_arg("audio_path", type=str, default=output_file,              help="预测的音频路径")
#add_arg("model_path", type=str, default="../whisper-medium-finetune",  help="合并模型的路径，或者是huggingface上模型的名称")
add_arg("model_path", type=str, default="./models/whisper-small-finetune-finetune",  help="合并模型的路径，或者是huggingface上模型的名称")
